import pytest
import re
from utils.misc import umlaut, unumlaut, format_date, open_default_html, get_default_matchday, get_default_season


@pytest.mark.parametrize(("word", "expected"), [
    ("f\\xc3\\xb6\\xc3\\xb6", "föö"),
    ("bar", "bar"),
    ("f\\xc3\\xbctbol", "fütbol"),
])
...
@pytest.mark.parametrize(("date", "expected"), [
    ("10.10.2010", "October 10, 2010"),
    ("1.2.2012", "February 1, 2012"),
])
