...
from utils.table_handler import tables_from_soup, get_table, find_team_in_table, extract_full_table_stats
...
@pytest.mark.online
@pytest.mark.parametrize(("full", "form", "home", "away", "expected"), [
...
@pytest.mark.online
@pytest.mark.parametrize(("team", "table", "expected"), [
...
@pytest.mark.parametrize(("row", "expected"), [
    (find_team_in_table("bayern", get_table(tables_from_soup(get_soup()), full=True)), ("1", "Bayern", "34", "24", "6", "4", "88:32", "56", "78"))
])
